...
class uint(int, BasicView):
    ...
    def __mul__(self: T, other: Union[T, int]) -> Union[T, int]:
    ...
    def __ilshift__(self: T, other: int) -> T:
        """Left bitwise shift with assignment at uint boundary"""
    ...
    def __neg__(self) -> None:  # type: ignore
